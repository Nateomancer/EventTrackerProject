...
The second part of this assignment was to create the front end.  This was the frist time creating a javascript front end for a full stack application, previously we used JSP pages with JSTL and EL. This felt very different compared to what I am user to.  Javascript's loose untyped syntax was tricky to get use to, but eventually it fell into place.
